...
class Migration1654525494MyQuery extends MigrationStep
{
     ...
     * @throws \Doctrine\DBAL\Exception
     */
    private function createCustomField(Connection $connection, string $customerFieldSetId): string
    {
     ...
     * @throws \Doctrine\DBAL\Exception
     */
    private function createFieldRelation(Connection $connection, string $customerFieldSetId): string
    {
